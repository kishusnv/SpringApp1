<%@ include file="common/header.jsp" %>
	...
	<div class="link">
		...
		<form:form modelAttribute="user" action="/cga/create" method="post">
	...
	<c:forEach var="current" items="${users}">
		...
		<td><a href="/cga/edit/${current.userName}">Edit</a></td>
		<td><a href="/cga/delete/${current.userName}">Delete</a></td>
		</tr>
	</c:forEach>
	</table>
	</c:if>
...
<script type="text/javascript">
	...
	$(function() {
		$("#save").click(function(event) {
        	$("#user").attr("action", "/cga/create")
			$("#user").submit();
		});

		$("#search").click(function(event) {
        	$("#user").attr("action", "/cga/search")
			$("#user").submit();
